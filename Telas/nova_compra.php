...
$produtos = $pdo->query("SELECT id_produto, tipo, qtde, id_fornecedor FROM produto ORDER BY tipo")->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <form method="post">
        ...
        <label>Funcionário  para receber comissão:</label>
        ...
        <input type="number" name="quantidade" min="1" max="<?= $p['qtde'] ?>"  required>
        <br><br>
